...
namespace Map
{
    [Tooltip("This script allows you to scroll a GameObject in the scene using the mouse. " +
                    "It also allows you to freeze the movement on the X or Y axis and set constraints for the movement. " +
                    "It uses the DOTween library for the tweening.")]
